...
/**
 * The function `buttonField` creates a button field with a label and optional additional options.
 * @param {string} [label = '] - The label parameter is a string that represents the label or text to be displayed
 * on the button field. It is optional and defaults to an empty string if not provided.
 * @param {FieldProperties}[options = {}] - An object that contains additional configuration options for the button field.
 * These options can include properties such as the button's size, color, and event handlers.
 * @returns {UiButtonField} a new instance of the `UiButtonField` class with the `options` object as its parameter.
 */
function buttonField(label = '', options = {}) {
    ...
    return new UiButtonField(options)
}

/**
 * @typedef {object} FieldChoice
 * @description The `FieldChoice` object represents a choice in a radio, select, or checkboxes field.
 ...
 * @param {string} [label = ''] - A string representing the label for the color field. It is an optional parameter
 ...
 * options.
 * @param {string} [label = ''] - A string representing the label for the number field. It is an optional parameter
 * and defaults to an empty string if not provided.
 ...
 * options.
 * @param {string} [label = ''] - A string representing the label for the textarea field. It is an optional parameter
 * and defaults to an empty string if not provided.
 ...
 * @param {string} [label = ''] - A string that represents the label for the date field. It is an optional parameter
 * and defaults to an empty string if not provided.
 ...
 * options.
 * @param {string} [label = ''] - A string representing the label for the datetime field. It is an optional parameter
 * and defaults to an empty string if not provided.
 ...
 * label and options.
 * @param {string} [label = ''] - The label parameter is a string that represents the label or name of the field. It
 ...
 * @param {string} [label = ''] - A string that represents the label for the email field. It is an optional parameter
 * and defaults to an empty string if not provided.
 ...
 * options.
 * @param {string} [label = ''] - The label parameter is a string that represents the label or name of the file
 ...
 * options.
 * @param {string} [label = ''] - The label parameter is a string that represents the label for the form field. It is
 ...
 * @param {string} [label = ''] - The label parameter is a string that represents the label for the hidden field. It
 ...
 * @param {string} [label = ''] - The label parameter is a string that represents the label or title for the image
 ...
 * additional options.
 * @param {string} [label = ''] - A string representing the label for the month field. It is an optional parameter
 * and defaults to an empty string if not provided.
 ...
 * @param {string} [label = ''] - The label parameter is a string that represents the label or name of the password
 * field. It is optional and can be left empty if no label is needed for the field.
 ...
 * @param {string} [label = ''] - The label parameter is a string that represents the label or title for the radio
 ...
 * options.
 * @param {string} [label = ''] - A string representing the label for the range field. It is an optional parameter
 * and defaults to an empty string if not provided.
...
/**
 * The function `resetField` creates a new `UiResetField` object with the provided label and options.
 * @param {string} [label = ''] - The `label` parameter is a string that represents the label for the field. It is an
 * optional parameter, so if no value is provided, it will default to an empty string.
 * @param {FieldProperties} [options = {}] - An object that contains additional configuration options for the reset field.
 * These options can include properties such as the field's initial value, placeholder text, and event
 * handlers.
 * @returns {UiResetField} a new instance of the `UiResetField` class with the `options` object as its parameter.
 */
function resetField(label = '', options = {}) {
    options = {
        ...options,
        ...getLabelAndRequired(label)
    }
    return new UiResetField(options)
}

/**
 * The function `searchField` creates a new instance of `UiSearchField` with the provided label and
 * options.
 * @param {string} [label = ''] - The label parameter is a string that represents the label or title of the search
 * field. It is optional and defaults to an empty string if not provided.
 * @param {FieldProperties} [options = {}] - The `options` parameter is an object that contains additional configuration
 ...
 * and options.
 * @param {string} [label = ''] - The label parameter is a string that represents the label or title of the field. It
 * is optional and defaults to an empty string if not provided.
...
/**
 * The function `submitField` creates a new `UiSubmitField` object with the provided label and options.
 * @param {string} [label = {}] - The label parameter is a string that represents the label or title of the field. It
 * is optional and can be left empty if no label is needed for the field.
 * @param {FieldProperties} [options = {}] - An object that contains additional options for the submit field. These options
 * can include properties such as the field's name, value, placeholder, and any other relevant
 * attributes or settings.
 * @returns {UiSubmitField} a new instance of the `UiSubmitField` class with the `options` object as its parameter.
 */
function submitField(label = '', options = {}) {
    options = {
        ...options,
        ...getLabelAndRequired(label)
    }
    return new UiSubmitField(options)
}


/**
 * The function `telField` creates a new `UiTelField` object with optional label and options.
 * @param {string} [label = ''] - A string that represents the label for the telephone field. It is an optional
 ...
 * options.
 * @param {string} [label = ''] - The label parameter is a string that represents the label or placeholder text for
 ...
 * options.
 * @param {string} [label = ''] - A string that represents the label for the time field. It is an optional parameter
 * and defaults to an empty string if not provided.
 ...
 * @param {string} [label = ''] - The label parameter is a string that represents the label or name of the URL field.
 ...
 * @param {string} [label = ''] - The `label` parameter is a string that represents the label for a form field.
