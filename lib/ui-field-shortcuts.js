 ...
 * @param {object} [options = {}] - The `options` parameter is an object that contains additional configuration
 ...
 * @param {Array<FieldChoices>}[choices = []] - The `choices` parameter is an array that contains the options for the checkboxes
 ...
 * @param [fields] - The `fields` parameter is an array that contains the input fields for the form.
 * Each element in the array represents a single input field.
 * @param [options] - An object that contains additional options for the form field. These options will
