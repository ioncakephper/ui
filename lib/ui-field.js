...
class UiFieldWithFields extends UiField {
     ...
     * @param [props] - An object containing the properties that will be passed to the constructor.
     */
    constructor(props = {}) {
        props = {
            ...{fields: []},
     ...
     * @param [values] - The `values` parameter is an object that contains any values that need to be
     ...
     * @param fieldValue - The `fieldValue` parameter is an object that contains the current values of
